...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        } else if (current.getRestaurant().equals("Boost Juice Bar")){
            holder.logo.setImageResource(R.drawable.boost_logo);
        } else if (current.getRestaurant().equals("Crave")){
            holder.logo.setImageResource(R.drawable.crave_logo);
        } else if (current.getRestaurant().equals("Long John Silver's")){
            holder.logo.setImageResource(R.drawable.ljs_logo);
        } else if (current.getRestaurant().equals("Ajisen Ramen")){
            holder.logo.setImageResource(R.drawable.ajisen_logo);
        } else {
